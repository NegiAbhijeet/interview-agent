...
export const GlowingCard: React.FC<GlowingCardProps> = ({
  ...
  return (
    <div
      className={cn(
        "relative flex-1 min-w-[14rem] h-full p-2 rounded-2xl text-black dark:text-white",
        "bg-background border card-border-color",
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "flex items-center justify-center flex-wrap gap-6",
        ...
        {enableGlow && (
          ...
          >
            <div
              className={cn(
                "flex items-center justify-center flex-wrap gap-6 max-w-[var(--max-width)] center mx-auto",
                responsive && "flex-col sm:flex-row"
              )}
              style={{ padding: "var(--padding)" }} // String literal
            >
