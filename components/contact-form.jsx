                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex space-x-4 mt-6">
                                    <a href="https://x.com/AinterviewAgent" target="_blank" rel="noopener noreferrer" className="rounded-full bg-gray-700 p-2 text-gray-300 hover:bg-indigo-100 hover:text-indigo-600">
                                        <FaTwitter size={20} />
                                    </a>
                                    <a href="https://www.instagram.com/aiinterviewagents?igsh=ZXQwa2FtdmEwbWZn" target="_blank" rel="noopener noreferrer" className="rounded-full bg-gray-700 p-2 text-gray-300 hover:bg-indigo-100 hover:text-pink-600">
                                        <FaInstagram size={20} />
                                    </a>
                                    <a href="https://www.linkedin.com/company/ai-interview-agent/?lipi=urn%3Ali%3Apage%3Ad_flagship3_company%3BJqRT4fS%2BROSIU6vuVd6WCQ%3D%3D" target="_blank" rel="noopener noreferrer" className="rounded-full bg-gray-700 p-2 text-gray-300 hover:bg-indigo-100 hover:text-indigo-600">
                                        <FaLinkedin size={20} />
                                    </a>
                                </div>
                            </div>
